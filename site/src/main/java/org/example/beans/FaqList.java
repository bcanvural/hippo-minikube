...
@HippoEssentialsGenerated(internalName = "myhippoproject:faqlist")
@Node(jcrType = "myhippoproject:faqlist")
public class FaqList extends BaseDocument {
    ...
    public List<FaqItem> getFaqItems() {
        return getLinkedBeans("myhippoproject:faqitem", FaqItem.class);
    }
